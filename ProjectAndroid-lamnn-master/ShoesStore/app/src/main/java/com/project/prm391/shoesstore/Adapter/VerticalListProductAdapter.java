...
/**
 * Created by lamtu on 2018-03-20.
 */

public class VerticalListProductAdapter extends RecyclerView.Adapter<VerticalListProductAdapter.ViewHolder> {
    private final Context context;
    private final List<Product> products;
    private Consumer<Product> onProductSelectedConsumer;

    public VerticalListProductAdapter(Context context, List<Product> products, Consumer<Product> onProductSelectedConsumer) {
        this.context = context;
        this.products = products;
        this.onProductSelectedConsumer = onProductSelectedConsumer;
    }

    public VerticalListProductAdapter(Context context, List<Product> products) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.vertical_list_product_item_layout, parent, false);
